...
void send_method_call(DBusConnection *connection)
{
    ...
    scanf("%d %d", &a, &b);
    printf("a= %d b=%d \n", a,b);
    msg = dbus_message_new_method_call("hello.world.Unity", "/hello/world","hello.world", "add");
    if(msg == NULL)
    {
        printf("no memory\n");
        return;
    }
    system("busctl  call  hello.world.Unity /hello/world hello.world add ii 1 1  --user ");
    dbus_message_iter_init_append(msg, &arg);
